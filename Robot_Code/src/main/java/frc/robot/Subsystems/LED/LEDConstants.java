...
public class LEDConstants {
    public static final double 
        ...
        kAlgaeIntakePosition = 0.83,//(sky blue) AlgaeIntake manipulator is at intake/grab position
        //kALgaeEJectPosition = ,
        kScoringLED = 0.73, //(lime) scoring game piece, coral or algae
        kBucketIntakePosition = 0.61,//(solid red) bucket is at position to intake coral from human-player station
        kBucketMiddlePosition = 0.97,
        kBucketOuttakePositon = 0.69,//(solid yellow) bucket is at position to dump coral in L1
